# Locking your dependancies
It is critical to lock your dependancies!
- It gaurantees that the build will always be the same
- It allows dependabot to validate for CVE's

## Add the Pipfile.lock
- Create a branch called `Deps`
- Add the following file to your repository: `/dependancies/Pipfile.lock`
- Commit the code
- Open Pull request
```json
{
