...
<details>
<summary>- Add the following file to your repository: `.github/workflows/deploy-prod-docker.yml`</summary>
...
<details>
<summary>- Add the following file to your repository: `.github/workflows/deploy-prod-gcr.yml`</summary>
      ...
      - name: Build and push
        ...
        with:
          ...
          tags: |
            ...
            ghcr.io/${{github.repository_owner}}/${{github.repository.name}}:v1
...
<details>
<summary>- Add the following file to your repository: `.github/workflows/deploy-prod-aws.yml`</summary>
